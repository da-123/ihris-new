Instance:       ihris-es-report-ethiopia-contract-staff
InstanceOf:     IhrisRelationship
Title:          "Contracts Relationship - Ethiopia"
Usage:          #example

* code.text = "iHRISRelationship"
* code.coding = #iHRISRelationship
* extension[reportdetails].extension[name].valueString = "contracts"
* extension[reportdetails].extension[label].valueString = "Employee Contract Report"
...
* extension[reportlink][0].extension[linkTo].valueString = "contracts"
* extension[reportlink][0].extension[linkElementSearchParameter].valueString = "practitioner"
* extension[reportlink][0].extension[query].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitionerrole-employment-status').valueCoding.code=contract"
* extension[reportlink][0].extension[multiple].valueBoolean = true
...
* extension[reportlink][0].extension[reportelement][5].extension[label].valueString = "jobType"
* extension[reportlink][0].extension[reportelement][5].extension[name].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitionerrole-job-type').valueCoding.display"
* extension[reportlink][0].extension[reportelement][5].extension[display].valueString = "Job Type"
