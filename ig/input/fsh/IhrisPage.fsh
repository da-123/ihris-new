...
* extension[section][11].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-ethiopia-leave-stock').extension.where(url='numDays').valueString"
...
* extension[section][16].extension[resource].extension[column][0].extension[header].valueString = "Education Level Category"
* extension[section][16].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-professional').extension.where(url='education_category').valueCoding.display"
* extension[section][16].extension[resource].extension[column][1].extension[header].valueString = "Education Level Sub Category"
* extension[section][16].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-professional').extension.where(url='education_sub_category').valueCoding.display"
* extension[section][16].extension[resource].extension[column][2].extension[header].valueString = "Professional Category Type"
* extension[section][16].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-professional').extension.where(url='profession').valueCoding.display"
* extension[section][16].extension[resource].extension[column][3].extension[header].valueString = "Professional Category"
* extension[section][16].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-professional').extension.where(url='profession_category').valueCoding.display"
* extension[section][16].extension[resource].extension[column][4].extension[header].valueString = "Professional Sub Category"
* extension[section][16].extension[resource].extension[column][4].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-professional').extension.where(url='profession_sub_category').valueCoding.display"
* extension[section][16].extension[resource].extension[column][5].extension[header].valueString = "Actions"
* extension[section][16].extension[resource].extension[column][5].extension[field].valueString = "_action"
