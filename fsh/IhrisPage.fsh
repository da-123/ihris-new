...
* extension[display].extension[search][6].valueString = "Gender|Practitioner.gender|http://www.hl7.org/fhir/administrative-gender"
* extension[display].extension[filter][0].valueString = "First Name|name:contains"
* extension[display].extension[filter][1].valueString = "Father's Name|Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-familynames').extension.where(url='fathers').valueString:contains"
* extension[display].extension[filter][2].valueString = "Grand Father's Name|Practitioner.extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitioner-familynames').extension.where(url='grandfatherslastname').valueString:contains"
* extension[display].extension[filter][3].valueString = "Employee ID|identifier.where(type.coding.code='employeeId'):contains"
* extension[display].extension[filter][4].valueString = "PIN ID|id:contains"
...
* extension[section][13].extension[resource].extension[column][0].extension[header].valueString = "Performance Type"
* extension[section][13].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='performanceType').valueCoding.display"
* extension[section][13].extension[resource].extension[column][1].extension[header].valueString = "Evaluator's Name"
* extension[section][13].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='evaluator').valueString"
* extension[section][13].extension[resource].extension[column][2].extension[header].valueString = "Score"
* extension[section][13].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='score').valueString"
* extension[section][13].extension[resource].extension[column][3].extension[header].valueString = "Start Date"
* extension[section][13].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='period').valuePeriod.start"
* extension[section][13].extension[resource].extension[column][4].extension[header].valueString = "End Date"
* extension[section][13].extension[resource].extension[column][4].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='period').valuePeriod.end"
...
* extension[section][14].extension[title].valueString = "Employment History"
* extension[section][14].extension[description].valueString = "Employment History for the Person"
* extension[section][14].extension[name].valueString = "employment-history"
* extension[section][14].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/ihris-basic-employment-history)
...
* extension[section][14].extension[resource].extension[column][0].extension[header].valueString = "Organization Name"
* extension[section][14].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-employment-history').extension.where(url='organization').valueString"
...
* extension[section][14].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/employment-history/ITEMID"
...
* extension[section][15].extension[title].valueString = "Professional License Category"
* extension[section][15].extension[description].valueString = "Professional License Category for the Person"
* extension[section][15].extension[name].valueString = "professional"
* extension[section][15].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/ihris-basic-professional)
...
* extension[section][15].extension[resource].extension[column][0].extension[header].valueString = "Professional License Category"
...
* extension[section][15].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/professional/ITEMID"
...
* extension[section][16].extension[title].valueString = "Emergency Contact"
* extension[section][16].extension[description].valueString = "Emergency Contact for the Person"
* extension[section][16].extension[name].valueString = "emergency"
* extension[section][16].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/ihris-basic-emergency)
...
* extension[section][16].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-emergency').extension.where(url='name').valueString"
* extension[section][16].extension[resource].extension[column][1].extension[header].valueString = "Relationship"
* extension[section][16].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-emergency').extension.where(url='relation').valueCoding.display"
* extension[section][16].extension[resource].extension[column][2].extension[header].valueString = "Mobile Phone"
* extension[section][16].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-emergency').extension.where(url='mobile').valueString"
* extension[section][16].extension[resource].extension[column][3].extension[header].valueString = "Location"
...
* extension[section][16].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/emergency/ITEMID"
...
* extension[section][17].extension[title].valueString = "Collateral"
* extension[section][17].extension[description].valueString = "Collateral for the Person"
* extension[section][17].extension[name].valueString = "collateral"
* extension[section][17].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/ihris-basic-collateral)
...
* extension[section][17].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-collateral').extension.where(url='name').valueString"
* extension[section][17].extension[resource].extension[column][1].extension[header].valueString = "Gender"
* extension[section][17].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-collateral').extension.where(url='gender').valueCoding.display"
* extension[section][17].extension[resource].extension[column][2].extension[header].valueString = "Mobile Phone"
* extension[section][17].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-collateral').extension.where(url='mobile').valueString"
...
* extension[section][17].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/collateral/ITEMID"
...
* extension[display].extension[filter][1].valueString = "Location Type|type|http://terminology.hl7.org/ValueSet/v3-ServiceDeliveryLocationRoleType"
