...
* extension[section][4].extension[field][1].valueString = "Practitioner.identifier"
* extension[section][4].extension[field][2].valueString = "Practitioner.identifier.use"
* extension[section][4].extension[field][3].valueString = "Practitioner.identifier.type"
* extension[section][4].extension[field][4].valueString = "Practitioner.identifier.value"
* extension[section][4].extension[field][5].valueString = "Practitioner.extension:drivingLicense"
