...
* extension[display].extension[search][4].valueString = "Birth Date|Practitioner.birthDate"
* extension[display].extension[search][5].valueString = "Gender|Practitioner.gender|http://www.hl7.org/fhir/administrative-gender"
...
* extension[section][8].extension[title].valueString = "Emergency Contact Details"
* extension[section][8].extension[description].valueString = "Emergency Contact"
* extension[section][8].extension[name].valueString = "emergencyContact"
* extension[section][8].extension[field][0].valueString = "Practitioner.extension:emergencyContact"
* extension[section][9].extension[title].valueString = "Collateral Details"
* extension[section][9].extension[description].valueString = "Collateral"
* extension[section][9].extension[name].valueString = "collateral"
* extension[section][9].extension[field][0].valueString = "Practitioner.extension:collateral"
* extension[section][10].extension[title].valueString = "Training Details"
* extension[section][10].extension[description].valueString = "Training Information"
* extension[section][10].extension[name].valueString = "training"
* extension[section][10].extension[field][0].valueString = "Practitioner.extension:specialTraining"
* extension[section][10].extension[field][1].valueString = "Practitioner.extension:category"
* extension[section][11].extension[title].valueString = "Remarks"
* extension[section][11].extension[description].valueString = "Remarks or Notes "
* extension[section][11].extension[name].valueString = "remarks"
* extension[section][11].extension[field][0].valueString = "Practitioner.extension:remarkNote"
* extension[section][12].extension[title].valueString = "Current Job Positions"
* extension[section][12].extension[description].valueString = "Position the person holds"
* extension[section][12].extension[name].valueString = "position"
* extension[section][12].extension[field][0].valueString = "PractitionerRole.code"
* extension[section][12].extension[resource].extension[resource].valueReference = Reference(StructureDefinition/ihris-job-description)
* extension[section][12].extension[resource].extension[linkfield].valueString = "PractitionerRole.practitioner"
* extension[section][12].extension[resource].extension[column][0].extension[header].valueString = "Job"
* extension[section][12].extension[resource].extension[column][0].extension[field].valueString = "PractitionerRole.code.coding[0]"
* extension[section][12].extension[resource].extension[column][1].extension[header].valueString = "Place Of Work"
* extension[section][12].extension[resource].extension[column][1].extension[field].valueString = "PractitionerRole.location.reference"
* extension[section][12].extension[resource].extension[column][2].extension[header].valueString = "First Employment Date"
* extension[section][12].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitionerrole-first-employment-date').valueDate"
* extension[section][12].extension[resource].extension[column][3].extension[header].valueString = "Start Date"
* extension[section][12].extension[resource].extension[column][3].extension[field].valueString = "PractitionerRole.period.start"
* extension[section][12].extension[resource].extension[column][4].extension[header].valueString = "Shift"
* extension[section][12].extension[resource].extension[column][4].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitionerrole-shift').valueCoding.display"
* extension[section][12].extension[resource].extension[column][5].extension[header].valueString = "Job Type"
* extension[section][12].extension[resource].extension[column][5].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitionerrole-job-type').valueCoding.display"
* extension[section][12].extension[resource].extension[column][6].extension[header].valueString = "Employment Status"
* extension[section][12].extension[resource].extension[column][6].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-practitionerrole-employment-status').valueCoding.display"
* extension[section][12].extension[resource].extension[column][7].extension[header].valueString = "End Date"
* extension[section][12].extension[resource].extension[column][7].extension[field].valueString = "PractitionerRole.period.end"
* extension[section][12].extension[resource].extension[column][8].extension[header].valueString = "Actions"
* extension[section][12].extension[resource].extension[column][8].extension[field].valueString = "_action"
* extension[section][12].extension[resource].extension[action][0].extension[link].valueString = "/resource/add/practitionerrole?PractitionerRole.practitioner.reference=Practitioner/FHIRID"
* extension[section][12].extension[resource].extension[action][0].extension[text].valueString = "Assign Job"
...
* extension[section][12].extension[resource].extension[action][0].extension[condition].valueString = "PractitionerRole.period.end.exists()"
* extension[section][12].extension[resource].extension[action][0].extension[class].valueString = "primary"
* extension[section][12].extension[resource].extension[action][1].extension[link].valueString = "/resource/view/practitionerrole/ITEMID"
...
* extension[section][12].extension[resource].extension[action][2].extension[link].valueString = "/questionnaire/ihris-endrole/practitioner?practitionerrole=ITEMID"
* extension[section][12].extension[resource].extension[action][2].extension[text].valueString = "Terminate Job"
* extension[section][12].extension[resource].extension[action][2].extension[row].valueBoolean = true
* extension[section][12].extension[resource].extension[action][2].extension[condition].valueString = "PractitionerRole.period.end.empty()"
* extension[section][12].extension[resource].extension[action][2].extension[class].valueString = "warning"
* extension[section][12].extension[resource].extension[action][3].extension[link].valueString = "/questionnaire/ihris-promotion-ethiopia/practitioner?practitionerrole=ITEMID"
* extension[section][12].extension[resource].extension[action][3].extension[text].valueString = "Change Position"
* extension[section][12].extension[resource].extension[action][3].extension[row].valueBoolean = true
* extension[section][12].extension[resource].extension[action][3].extension[condition].valueString = "PractitionerRole.period.end.empty()"
* extension[section][12].extension[resource].extension[action][3].extension[class].valueString = "accent"
...
* extension[section][13].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/ihris-leave-ethiopia/practitioner?practitioner=FHIRID"
...
* extension[section][14].extension[resource].extension[column][2].extension[header].valueString = "level"
* extension[section][14].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='level').valueCoding"
* extension[section][14].extension[resource].extension[column][3].extension[header].valueString = "Educational Major"
* extension[section][14].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='educationalMajor').valueCoding"
* extension[section][14].extension[resource].extension[column][4].extension[header].valueString = "Year"
* extension[section][14].extension[resource].extension[column][4].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-education-history').extension.where(url='year').valueDate"
...
* extension[section][14].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/ihris-education-history/practitioner?practitioner=FHIRID"
...
* extension[section][15].extension[resource].extension[column][0].extension[header].valueString = "Evaluator's Name"
* extension[section][15].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='evaluator').valueString"
* extension[section][15].extension[resource].extension[column][1].extension[header].valueString = "Score"
* extension[section][15].extension[resource].extension[column][1].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='score').valueCoding.display"
* extension[section][15].extension[resource].extension[column][2].extension[header].valueString = "Start Date"
* extension[section][15].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='period').valuePeriod.start"
* extension[section][15].extension[resource].extension[column][3].extension[header].valueString = "End Date"
* extension[section][15].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-performance').extension.where(url='period').valuePeriod.end"
...
* extension[section][15].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/ihris-performance/practitioner?practitioner=FHIRID"
...
* extension[section][16].extension[resource].extension[column][2].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-employment-history').extension.where(url='dateStarted').valueDate"
* extension[section][16].extension[resource].extension[column][3].extension[header].valueString = "Date Ended"
* extension[section][16].extension[resource].extension[column][3].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-employment-history').extension.where(url='dateEnded').valueDate"
...
* extension[section][16].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/ihris-employment-history/practitioner?practitioner=FHIRID"
* extension[section][16].extension[resource].extension[action][0].extension[text].valueString = "Add Employment History Evaluation"
...
* extension[section][17].extension[resource].extension[column][0].extension[header].valueString = "Professional License Category"
* extension[section][17].extension[resource].extension[column][0].extension[field].valueString = "extension.where(url='http://ihris.org/fhir/StructureDefinition/ihris-professional').extension.where(url='profession').valueCoding.display"
* extension[section][17].extension[resource].extension[column][1].extension[header].valueString = "Actions"
* extension[section][17].extension[resource].extension[column][1].extension[field].valueString = "_action"
* extension[section][17].extension[resource].extension[action][0].extension[link].valueString = "/questionnaire/ihris-professional/practitioner?practitioner=FHIRID"
...
Usage:          #example
* code = IhrisResourceCodeSystem#page
* extension[display].extension[resource].valueReference = Reference(CodeSystem/ihris-ethiopia-pefix-codesystem)
* extension[display].extension[search][0].valueString = "Code|code"
* extension[display].extension[search][1].valueString = "Display|display"
* extension[display].extension[field][0].extension[path].valueString = "CodeSystem.code"
* extension[display].extension[field][0].extension[readOnlyIfSet].valueBoolean = true
