...
* extension[display].extension[search][3].valueString = "Birth Date|birthDate"
* extension[display].extension[search][4].valueString = "Gender|gender"
...
* extension[display].extension[search][0].valueString = "Job|code.coding.display"
* extension[display].extension[search][1].valueString = "Start Date|period.start"
* extension[display].extension[search][2].valueString = "Practitioner|practitioner.reference"
* extension[display].extension[search][3].valueString = "Facility|location.reference"
