...
* extension[section][0].extension[field][0].valueString = "Person.name.text"
...
* item[0].item[5].linkId = "Person.extension[2]"
* item[0].item[5].definition = "http://ihris.org/fhir/StructureDefinition/ihris-personal-information#Practitioner.extension:residence.value[x]:valueReference"
* item[0].item[5].text = "Location(If Needed )"
* item[0].item[5].type = #reference
* item[0].item[5].required = false
* item[0].item[5].repeats = false

* item[0].item[6].linkId = "Person.extension[3]"
* item[0].item[6].definition = "http://ihris.org/fhir/StructureDefinition/ihris-job-description#PractitionerRole.location"
* item[0].item[6].text = "Facility(If Needed )"
* item[0].item[6].type = #reference
* item[0].item[6].required = false
* item[0].item[6].repeats = false

* item[0].item[7].linkId = "Person.extension[1].extension[0]#password"
* item[0].item[7].text = "Password"
* item[0].item[7].type = #string
* item[0].item[7].required = true
* item[0].item[7].repeats = false

* item[0].item[8].linkId = "Person.extension[1].extension[1]#password"
