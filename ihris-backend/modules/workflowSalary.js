        ...
        if ( req.body && req.body.item 
          ...
          && req.body.item[0].item[0].answer && req.body.item[0].item[0].answer[0]) {
            ...
            if ( req.body.item[0].item[0].linkId === "Basic.extension[0].extension[0]" 
                ...
                complexExt.push({ url: "salaryladder",
            ...
            if ( req.body.item[0].item[2].linkId === "Basic.extension[0].extension[2]" 
                ...
                complexExt.push({ url: "salaryStep",
            ...
            if ( req.body.item[0].item[3].linkId === "Basic.extension[0].extension[3]" 
                ...
                total = total + parseInt(req.body.item[0].item[3].answer[0].valueString)
            }
            ...
            if ( req.body.item[0].item[8].linkId === "Basic.extension[0].extension[8]" 
                ...
                && req.body.item[0].item[8].answer[0].valueBoolean){
                complexExt.push({ url: "reviewed",
                valueBoolean: req.body.item[0].item[8].answer[0].valueBoolean })
            }
            ...
            if ( req.body.item[0].item[12].linkId === "Basic.extension[0].extension[12]" 
                ...
                && req.body.item[0].item[12].answer[0].valueBoolean){
                complexExt.push({ url: "current",
                valueBoolean: req.body.item[0].item[12].answer[0].valueBoolean })
            }
            if(complexExt){
