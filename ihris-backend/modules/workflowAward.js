        ...
        if ( req.body && req.body.item 
          ...
          && req.body.item[0].item[0].answer && req.body.item[0].item[0].answer[0]) {
            ...
            if ( req.body.item[0].item[3].linkId === "Basic.extension[0].extension[3]" 
                ...
                && req.body.item[0].item[3].answer[0].valueText){
                complexExt.push({ url: "remark",
                valueString: req.body.item[0].item[3].answer[0].valueText
                            })
            }
            if(complexExt){
                extensions.push({ url: "http://ihris.org/fhir/StructureDefinition/ihris-award",
                extension: complexExt})
            }
          let newAward = {
            resourceType: "Basic",
            meta: {
              profile: [ "http://ihris.org/fhir/StructureDefinition/ihris-basic-award" ]
            },
